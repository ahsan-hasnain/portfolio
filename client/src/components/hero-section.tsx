...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="relative container mx-auto p-6 my-20 z-10">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              variant="outline"
              className="border-2 border-brand-brown text-white px-8 py-4 text-lg font-semibold bg-brand-brown hover:bg-brand-brown transition-colors"
